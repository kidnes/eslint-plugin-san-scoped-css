...
import plugin from '../../../../';
import pluginSan from 'eslint-plugin-san';
...
const CATEGORY_TITLES = {
    ...
    'eslint-core-rules@Node.js and CommonJS': 'ESLint core rules(Node.js and CommonJS)',
...
for (const k of Object.keys(pluginSan.rules)) {
    const rule = pluginSan.rules[k];
    allRules.push({
...
allRules.sort((a, b) => (a.ruleId > b.ruleId ? 1 : a.ruleId < b.ruleId ? -1 : 0));
